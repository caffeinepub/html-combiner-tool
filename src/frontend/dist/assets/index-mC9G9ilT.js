...
const Combine = createLucideIcon("combine", __iconNode$e);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const FileCode2 = createLucideIcon("file-code-2", __iconNode$a);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const FileCog = createLucideIcon("file-cog", __iconNode$8);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function TabFileIcon({ language }) {
  if (language === "html")
    return /* @__PURE__ */ jsxRuntimeExports.jsx(FileCode, { className: "w-3 h-3 text-html shrink-0" });
  if (language === "css")
    return /* @__PURE__ */ jsxRuntimeExports.jsx(FileCog, { className: "w-3 h-3 text-css shrink-0" });
  if (language === "js")
    return /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-3 h-3 text-js shrink-0" });
  return /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-3 h-3 text-muted-foreground shrink-0" });
}
function EditorArea({
  files,
  openTabs,
  ...
  const lineCount = ((activeFile == null ? void 0 : activeFile.content) ?? "").split("\n").length;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: openTabs.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 flex items-center h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground/25 code-font italic", children: "No files open" }) }) : openTabs.map((tabId, idx) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              className: `group flex items-center gap-1.5 px-3 h-[40px] text-xs code-font border-r border-border shrink-0 transition-colors relative ${isActive ? "tab-active text-foreground" : "ide-tabbar text-muted-foreground/60 hover:text-muted-foreground hover:bg-accent/40"}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    ...
                    style: {
                      background: isActive ? "oklch(0.76 0.14 190)" : "transparent"
                    }
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TabFileIcon, { language: file.language }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "max-w-[120px] truncate", children: file.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    ...
                    className: `w-4 h-4 flex items-center justify-center rounded transition-all duration-100 ml-0.5 hover:bg-accent ${isActive ? "text-muted-foreground/50 hover:text-foreground" : "text-transparent group-hover:text-muted-foreground/40 hover:!text-foreground"}`,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-hidden relative", children: !activeFile ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded border border-border/40 flex items-center justify-center bg-muted/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FileCode, { className: "w-5 h-5 text-muted-foreground/20" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground/30 code-font", children: "Open a file from the explorer" })
    ...
    activeFile && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ide-statusbar border-t border-border/80 px-3 py-0.5 flex items-center justify-end gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "span",
      {
        className: `text-[10px] code-font ${activeFile.language === "html" ? "text-html" : activeFile.language === "css" ? "text-css" : activeFile.language === "js" ? "text-js" : "text-muted-foreground/40"}`,
        children: activeFile.language ? langLabel[activeFile.language] : "Plain Text"
      }
    ) })
  ] });
}
...
function FileIcon({ language }) {
  if (language === "html")
    return /* @__PURE__ */ jsxRuntimeExports.jsx(FileCode, { className: "w-3.5 h-3.5 text-html shrink-0" });
  if (language === "css")
    return /* @__PURE__ */ jsxRuntimeExports.jsx(FileCog, { className: "w-3.5 h-3.5 text-css shrink-0" });
  if (language === "js")
    return /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-3.5 h-3.5 text-js shrink-0" });
  return /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-3.5 h-3.5 text-muted-foreground shrink-0" });
}
function TreeNode({
  node,
  allFiles,
  ...
  const renameRef = reactExports.useRef(null);
  const addMenuRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
  ...
  const children = allFiles.filter((f) => f.parentId === node.id).sort((a, b) => a.order - b.order);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      ...
      {
        "data-ocid": ocid,
        className: `group flex items-center gap-1 px-2 py-[3px] cursor-pointer rounded-sm mx-1 transition-colors relative ${isActive ? "bg-accent text-foreground" : isOpen ? "text-foreground/80" : "text-muted-foreground hover:text-foreground hover:bg-accent/60"}`,
        ...
        children: [
          node.type === "folder" ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-3 h-3 flex items-center justify-center text-muted-foreground/60", children: isExpanded ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-3 h-3" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-3 h-3" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-3" }),
          node.type === "folder" ? isExpanded ? /* @__PURE__ */ jsxRuntimeExports.jsx(FolderOpen, { className: "w-3.5 h-3.5 text-primary/80 shrink-0" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Folder, { className: "w-3.5 h-3.5 text-primary/60 shrink-0" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(FileIcon, { language: node.language }),
          ...
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 min-w-0 truncate text-xs code-font", children: node.name }),
          isHovered && !isRenaming && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                node.type === "folder" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", ref: addMenuRef, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                  ...
                  showAddMenu && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute right-0 top-5 z-50 bg-popover border border-border rounded shadow-lg py-1 min-w-[80px]", children: ["html", "css", "js"].map((lang) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                      className: `w-full text-left px-3 py-1 text-[11px] font-mono font-bold uppercase hover:bg-accent transition-colors ${lang === "html" ? "text-html" : lang === "css" ? "text-css" : "text-js"}`,
                      onClick: () => {
    ...
    node.type === "folder" && isExpanded && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: children.map((child, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      TreeNode,
      {
        node: child,
        allFiles,
...
function FileExplorer({
  ...
  const rootNodes = files.filter((f) => f.parentId === null).sort((a, b) => a.order - b.order);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ide-sidebar h-full flex flex-col border-r border-border", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-3 py-2 border-b border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-semibold uppercase tracking-widest text-muted-foreground/70", children: "Explorer" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-1", children: rootNodes.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-6 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground/40 code-font", children: "No files yet." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
    ...
    ] }) : rootNodes.map((node, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      TreeNode,
      {
        node,
        allFiles: files,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-2 border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] text-muted-foreground/30 code-font text-center", children: "Double-click to rename" }) })
  ] });
}
...
function OutputPanel({ output, hasGenerated }) {
  ...
  const handleDownload = reactExports.useCallback(() => {
    ...
    ue.success("Downloaded combined.html");
  }, [output]);
  return (
    /*
    ...
    */
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ide-sidebar border-l border-border h-full flex flex-col", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "code", className: "flex flex-col h-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-semibold uppercase tracking-widest text-muted-foreground/40 code-font", children: "Output" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-3 bg-border/60" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "bg-transparent gap-0 h-6 p-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  TabsTrigger,
                  {
            ...
            hasGenerated && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-0.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "code", className: "flex-1 mt-0 overflow-hidden", children: !hasGenerated ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(FileCode2, { className: "w-4 h-4 text-muted-foreground/20" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground/40 code-font", children: "No output yet" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-muted-foreground/25 mt-1", children: [
                "Click",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary/60", children: "Combine & Preview" })
              ] })
            ] })
          ]
        }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "preview", className: "flex-1 mt-0 overflow-hidden", children: !hasGenerated ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full flex flex-col items-center justify-center gap-3 p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "w-10 h-10 rounded border border-border/40 flex items-center justify-center",
            style: { background: "oklch(0.10 0 0)" },
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { className: "w-4 h-4 text-muted-foreground/20" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground/40 code-font", children: "No preview yet" })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
        "iframe",
        {
...
function getDefaultContent(language, name) {
  switch (language) {
    case "html":
      return `<!DOCTYPE html>
<html lang="en">
...
function combineHTML(htmlFiles, cssFiles, jsFiles) {
  const combinedCss = cssFiles.map((f) => `/* === source: ${f.name} === */
${f.content.trim()}`).join("\n\n");
  const combinedJs = jsFiles.map((f) => `// === source: ${f.name} ===
${f.content.trim()}`).join("\n\n");
...
<html lang="en">
  ...
  const secondarySections = htmlFiles.slice(1).map((f) => {
...
function generateId(prefix2 = "node") {
  return `${prefix2}-${Date.now()}-${Math.random().toString(36).slice(2, 7)}`;
}
function App() {
  const [files, setFiles] = reactExports.useState(DEFAULT_FILES);
  const [openTabs, setOpenTabs] = reactExports.useState(["file-index-html"]);
  ...
  const [projectName, setProjectName] = reactExports.useState("My Project");
  const [isEditingName, setIsEditingName] = reactExports.useState(false);
  const [statusMsg, setStatusMsg] = reactExports.useState("Ready");
  const projectNameRef = reactExports.useRef(null);
  const handleFileClick = reactExports.useCallback((id) => {
    setOpenTabs((prev) => prev.includes(id) ? prev : [...prev, id]);
    setActiveTabId(id);
  }, []);
  const handleTabClick = reactExports.useCallback((id) => {
    setActiveTabId(id);
  }, []);
  ...
  const handleContentChange = reactExports.useCallback((id, content) => {
  ...
  const handleDeleteNode = reactExports.useCallback(
    (id) => {
      ...
      while (queue.length) {
        ...
        toDelete.add(cur);
        for (const f of allFiles.filter((f2) => f2.parentId === cur)) {
          queue.push(f.id);
        }
      }
  ...
  const handleRenameNode = reactExports.useCallback((id, newName) => {
    setFiles(
      (prev) => prev.map((f) => f.id === id ? { ...f, name: newName } : f)
    );
    setStatusMsg(`Renamed to ${newName}`);
  }, []);
  const handleAddFile = reactExports.useCallback(
    (parentId, language) => {
      const ext = language === "js" ? ".js" : language === "css" ? ".css" : ".html";
  ...
  const handleAddFolder = reactExports.useCallback(
    (parentId) => {
  ...
  const handleCombine = reactExports.useCallback(() => {
    const allFileNodes = files.filter((f) => f.type === "file");
    const htmlFiles = allFileNodes.filter((f) => f.language === "html").map((f) => ({ name: f.name, content: f.content ?? "" }));
    const cssFiles = allFileNodes.filter((f) => f.language === "css").map((f) => ({ name: f.name, content: f.content ?? "" }));
    const jsFiles = allFileNodes.filter((f) => f.language === "js").map((f) => ({ name: f.name, content: f.content ?? "" }));
    const result = combineHTML(htmlFiles, cssFiles, jsFiles);
    setOutput(result);
    setHasGenerated(true);
    const lineCount = result.split("\n").length;
    setStatusMsg(`Combined — ${lineCount} lines`);
    ue.success("Combined successfully!", {
  ...
  const handleDownload = reactExports.useCallback(() => {
    ...
    a.click();
    URL.revokeObjectURL(url);
    ue.success("File downloaded!");
  }, [output, projectName]);
  const fileCount = files.filter((f) => f.type === "file").length;
  const activeFile = files.find((f) => f.id === activeTabId);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-screen flex flex-col overflow-hidden bg-background text-foreground", children: [
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                style: {
                  background: "linear-gradient(135deg, oklch(0.76 0.14 190), oklch(0.60 0.18 230))",
                  boxShadow: "0 0 10px oklch(0.76 0.14 190 / 0.30)"
                },
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Combine, { className: "w-3.5 h-3.5 text-primary-foreground" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[14px] font-bold leading-none text-foreground tracking-tight", children: "HTML Combiner" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] text-muted-foreground/50 leading-none mt-0.5 code-font uppercase tracking-widest", children: "IDE" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-5 bg-border/70 shrink-0" }),
          isEditingName ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            "button",
            {
              ...
              children: [
                projectName,
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-muted-foreground/30 group-hover:text-muted-foreground/60 transition-colors", children: "✎" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1" }),
          hasGenerated && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              "data-ocid": "download.primary_button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-[220px] shrink-0 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        FileExplorer,
        {
          files,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-hidden ide-panel panel-inset", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        EditorArea,
        {
          files,
          openTabs,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-[380px] shrink-0 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(OutputPanel, { output, hasGenerated }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "ide-statusbar border-t border-border/80 h-[22px] flex items-center px-3 gap-3 shrink-0", children: [
      (activeFile == null ? void 0 : activeFile.language) && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
          className: `text-[9px] font-bold uppercase px-1.5 py-px rounded code-font ${activeFile.language === "html" ? "bg-html/10 text-html" : activeFile.language === "css" ? "bg-css/10 text-css" : "bg-js/10 text-js"}`,
          children: activeFile.language.toUpperCase()
        }
      ),
      activeFile && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground/60 code-font truncate max-w-[160px]", children: activeFile.name }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] text-muted-foreground/35 code-font", children: [
        fileCount,
        " file",
        fileCount !== 1 ? "s" : ""
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground/45 code-font", children: statusMsg }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-3 bg-border/50" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] text-muted-foreground/30 code-font", children: [
        "© ",
